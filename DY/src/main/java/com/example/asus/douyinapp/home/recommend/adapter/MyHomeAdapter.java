...
import static com.example.asus.douyinapp.R.color.RED;
import static com.example.asus.douyinapp.R.drawable.*;
...
public class MyHomeAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        final ImageView reco_dislike = view.findViewById(R.id.reco_dislike);
        ss = false;
        if (ss == false) {
            reco_dislike.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    reco_dislike.setImageResource(R.drawable.ax1);
                    ss = true;
                }
            });
        }
        if (ss == true) {
            reco_dislike.setImageResource(R.drawable.ax2);
        }
